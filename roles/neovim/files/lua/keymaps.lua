...
MsConfig.keys.normal("<leader>s", ":w<CR>", "Save")
...
MsConfig.keys.normal("<A-j>", "30j", "Scroll down")
MsConfig.keys.normal("<A-k>", "30k", "Scroll up")
MsConfig.keys.visual_block("<A-j>", "30j", "Scroll down")
MsConfig.keys.visual_block("<A-k>", "30k", "Scroll up")
